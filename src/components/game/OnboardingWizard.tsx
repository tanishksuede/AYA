...
export function OnboardingWizard() {
    ...
    return (
        <div className="relative h-full w-full bg-[#0a0a0f] flex flex-col justify-center px-4 md:px-8 py-12 overflow-y-auto overflow-x-hidden selection:bg-[#00f1fe] selection:text-black">
